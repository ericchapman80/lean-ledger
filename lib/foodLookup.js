...
export function calculatePortionMacros(productData, portionGrams) {
  ...
  return {
    protein: parseFloat((productData.proteinPer100g * multiplier).toFixed(1)),
    carbs: parseFloat((productData.carbsPer100g * multiplier).toFixed(1)),
    fat: parseFloat((productData.fatPer100g * multiplier).toFixed(1)),
