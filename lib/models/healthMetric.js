...
export async function upsert(data) {
  const rows = await sql`
    INSERT INTO health_metrics (
      user_id, recorded_at, date, weight, waist_measurement, workout_completed, hydration_ounces,
      ...
      ${data.workoutCompleted}, ${data.hydrationOunces}, ${data.energyLevel}, ${data.hungerLevel},
