...
export async function upsert(data) {
  const rows = await sql`
    INSERT INTO health_metrics (
      user_id, recorded_at, date, weight, waist_measurement, workout_completed, reading_completed, prayer_completed, hydration_ounces,
      ...
      ${data.userId}, ${data.recordedAt}, ${data.date}, ${data.weight}, ${data.waistMeasurement},
      ${data.workoutCompleted}, ${data.readingCompleted}, ${data.prayerCompleted}, ${data.hydrationOunces}, ${data.energyLevel}, ${data.hungerLevel},
