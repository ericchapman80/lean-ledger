...
export async function create(data) {
  const rows = await sql`
    INSERT INTO meals (user_id, date, meal_name, protein, fat, carbs, calories)
    VALUES (${data.userId}, ${data.date}, ${data.mealName}, ${data.protein}, ${data.fat}, ${data.carbs}, ${data.calories})
    RETURNING *
  `;
