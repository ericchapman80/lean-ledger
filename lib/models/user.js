...
import { mapGoalStrategyToLegacyGoal, normalizeActivityFocus } from '../coachingProfile.js';
...
export async function createWithId(id, data) {
  ...
  const activityFocus = normalizeActivityFocus(data.activityFocus);
  const rows = await sql`
    INSERT INTO users (
      ...
      ${data.gender},
      ${data.activityLevel},
      ${data.goal ?? mapGoalStrategyToLegacyGoal(goalStrategy)},
