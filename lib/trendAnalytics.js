...
import { getActiveDailyWinDefinitions, isDailyWinComplete } from '@/lib/dailyWins.js';
...
function buildDailyWinsBehaviorSummary(dailySeries, activeDailyWins) {
  const definitions = getActiveDailyWinDefinitions(activeDailyWins);
...
export function buildTrendAnalytics({
  ...
  const dailyWinsBehavior = buildDailyWinsBehaviorSummary(dailySeries, profile.dailyWinsActiveKeys);
