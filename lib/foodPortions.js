...
export function calculateMacrosForPortion(productData, amount, unit) {
  ...
  return {
    ...
    fiber: roundToTwo((productData.fiberPer100g || 0) * multiplier),
    sugarAlcohols: roundToTwo((productData.sugarAlcoholsPer100g || 0) * multiplier),
    netCarbs: calculateNetCarbs(
      productData.carbsPer100g * multiplier,
      (productData.fiberPer100g || 0) * multiplier,
      (productData.sugarAlcoholsPer100g || 0) * multiplier,
    ),
